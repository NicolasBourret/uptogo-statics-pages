  ...
  <div className="about">
    ...
    <div className="padding-h-2 margin-v-4">
      ...
      <p>
        ...
        recouverts de posters de la Ford Mustang de Steve Mc Queen dans Bullitt,
        de la Ferrari 308 GTS de Magnum, de la FALCON GTB de Mad Max ou encore
        l’Aston Martin DB5 de James Bond !<br />
        Au milieu des cassettes VHS de vos films préférés, vous vous imaginiez,
        parcourant le monde au volant d’un des ces beaux bolides, en vous
        chamaillant avec vos copains pour savoir quelle était le meilleure
        voiture au monde.
        <br />
      ...
      <p>
        ...
        <br />
        Ces deux amis ont toujours eu l’amour des belles mécaniques et le souci
        du détail.
      </p>
      <p>
        Ainsi, et après de longues recherches restées vaines sur les sites
        d’annonces traditionnels, ils décidèrent de créer une réelle plateforme
        détaillée, conçue pour les puristes et passionnés d’automobiles dans le
        même état d’esprit qu’eux.
      </p>
      <p>
        De l’idée à la concrétisation, ils ont créé une marketplace
        d’annonces-vidéos dédiée aux véhicules Premium et Sportifs, innovante et
        facile d’utilisation, réservée à une communauté de passionnés.
      </p>
    </div>
    <div className="padding-h-2 margin-v-4">
      ...
      >
        <SwiperSlide>
          <div className="engagement">
            ...
            <p>
              UPTOGO est simple d’utilisation. Néanmoins, toutes les données des
              passionnés utilisateurs sont confidentielles. Toutes diffusion,
              publication, totale ou partielle ou divulgation de ces données
              sous quelque forme que ce soit non expressément autorisées sont
              proscrites.
            </p>
          </div>
        </SwiperSlide>
        <SwiperSlide>
          <div className="engagement">
            ...
            <p>
              L’expérience est unique et ludique tout en respectant une sécurité
              maximale des données personnelles des utilisateurs.
            </p>
          </div>
        </SwiperSlide>
        <SwiperSlide>
        ...
        >
          <SwiperSlide>
            <div>
              ...
              <p>
                Lorsque j’achetais une voiture d’occasion, j’ai été trop souvent
                confronté à la même problématique ! Je souhaitais trouver la
                perle rare incluant certaines options indispensables pour moi
                comme le pack carbone, des sièges baquets, des échappements
                sport, une caméra 360°…
              </p>
              <p>
          ...
          <SwiperSlide>
            <div>
              ...
              <p>
                Fan depuis toujours des voitures de Sport et Premium, j’ai eu la
                chance d’en posséder quelques-unes ! Amaury et moi travaillons
                quotidiennement depuis douze ans ensemble. Outre le plaisir de
                collaborer ensemble, Amaury m’a également transmis le goût des
                belles voitures américaines ! Après une Ford Mustang GT V8, me
                voilà désormais au volant d’une Ford Mustang RTR (édition lim. à
                500 ex). Mais que de soucis pour trouver ma perle rare…
              </p>
              <p>
                Mais tout cela est maintenant derrière ! L’alliance de nos
                expériences passées, principalement en développement de projets
                marketing et la création et l’innovation de UPTOGO va, je suis
                persuadé, constituer un cocktail détonnant !
              </p>
              <p>
                Amateurs de belles mécaniques, cette marketplace a été conçue et
                réalisée pour vous !
              </p>
            </div>
          </SwiperSlide>
    ...
    <div className="padding-h-2 margin-v-4">
      ...
      <p>
        Alain F., Alexandre P., Alexandre V., Benjamin C., Carlos D., Christophe
        B., Christophe C., Daniel P., Dimitri T., Dominique B., Elodie C., Erwan
        L., Erwan G., Florian., Francesca C., Gaëlle L., Giovanni T.,
        Guillaume., Isabelle B., José D., Joël T., Jules V., Kevin Z., Laurent
        L., Loïc G., Maxime S., Michel L., Pascal V., Serge M., Thomas B.,
        Vincent G., Yannick A.
      </p>
    </div>
    <div className="padding-h-2 margin-v-4 large-flex">
      <p>
